...
CREATE TABLE anamnese (
    ...
    dcse NULL,
    dcsi NULL,
    somatoria_4_dobras NULL,
    porcentagem_gordura_corporal_somatoria_4_dobras NULL,
    peso_gordura NULL,
    ...
    porcentagem_agua_massa_magra NULL,
    emap_direita NULL,
    emap_esquerda NULL,
    forca_preencao_manual_direita INT NULL,
    forca_preencao_manual_esquerda INT NULL,
    metas TEXT NULL,
